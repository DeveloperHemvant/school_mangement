        ...
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-3/4 lg:w-1/2"
                ...
                <div class="px-6 py-4">
                    ...
                    <form wire:submit.prevent="updateRole" class="mb-4">
                        <div class="flex mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center mb-2">
                                <input type="checkbox" wire:model="updatedPermissions" value="{{ $permission['id'] }}" class="mr-2"  
                                    @if ($editrole->permissions->pluck('id')->toArray() && in_array($permission['id'], $editrole->permissions->pluck('id')->toArray()))
                                        checked
                                    @endif
                                >
                        ...
                        <button class="px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600" type="submit">Update Role</button>
                    </form>
                @else
                <h1 class="text-3xl font-bold mb-4">Create New Role</h1>
