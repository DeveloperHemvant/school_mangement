<div x-app title="Admin Login" class='hello'>
    {{-- <x-app title="Admin Login" > --}}
    
        <x-slot name="header">
            <x-navigation title="Admin Login  Page"/>
        </x-slot>
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                ...
                <form wire:submit="login">
                    ...
                    <div class="mb-4">
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" type="text" model="email"/>
                    </div>
                    <div class="mb-4">
